...
<body>
    ...
    <table style="
      ...
      font-family: system-ui;" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr style="display: none;">
                <td>
                    <label style="font-family: system-ui;" for="endereco "><strong>Endere&ccedil;o de origem</strong></label>
                    <br>
                    <input type="text" id="endereco" class="field" style="width: 300px;font-family: system-ui;
...
">&nbsp;</span></div>
  ...
  ">
    ...
    <form style="display: flex; justify-content: center; align-items: center;" action="">
        <button style="background-color: #5098bc; display: flex; align-items: center; justify-content: space-evenly;" value="" type="button" class="button success">
